...
class OutlinePass extends Pass {
  ...
  OutlinePass(Vector2? resolution, Scene scene, Camera camera,
    ...
    renderTargetMaskBuffer =
        WebGLRenderTarget(this.resolution.x.toInt(), this.resolution.y.toInt());
    ...
    prepareMaskMaterial.fragmentShader =
        _replaceDepthToViewZ(prepareMaskMaterial.fragmentShader, renderCamera);

    renderTargetDepthBuffer = WebGLRenderTarget(
        this.resolution.x.toInt(),
        this.resolution.y.toInt(),
        WebGLRenderTargetOptions({'type': HalfFloatType}));
    ...
    renderTargetMaskDownSampleBuffer = WebGLRenderTarget(
        resx, resy, WebGLRenderTargetOptions({'type': HalfFloatType}));
    renderTargetMaskDownSampleBuffer.texture.name =
    ...
    renderTargetBlurBuffer2 = WebGLRenderTarget((resx / 2).round(),
        (resy / 2).round(), WebGLRenderTargetOptions({'type': HalfFloatType}));
    ...
    renderTargetEdgeBuffer2 = WebGLRenderTarget((resx / 2).round(),
        (resy / 2).round(), WebGLRenderTargetOptions({'type': HalfFloatType}));
    ...
    separableBlurMaterial1.uniforms['texSize']['value']
        .setValues(resx.toDouble(), resy.toDouble());
    separableBlurMaterial1.uniforms['kernelRadius']['value'] = 1.0;
    separableBlurMaterial2 = getSeperableBlurMaterial(MAX_EDGE_GLOW);
    separableBlurMaterial2.uniforms['texSize']['value']
        .setValues((resx / 2).roundToDouble(), (resy / 2).roundToDouble());
  ...
  void updateTextureMatrix() {
    textureMatrix.setValues(0.5, 0.0, 0.0, 0.5, 0.0, 0.5, 0.0, 0.5, 0.0, 0.0,
  ...
  @override
  void render(WebGLRenderer renderer, writeBuffer, readBuffer,
    ...
    if (selectedObjects.isNotEmpty) {
      ...
      prepareMaskMaterial.uniforms['cameraNearFar']['value']
          .setValues(renderCamera.near, renderCamera.far);
      prepareMaskMaterial.uniforms['depthTexture']['value'] =
          renderTargetDepthBuffer.texture;
      ...
      if (pulsePeriod > 0) {
        final scalar = (1 + 0.25) / 2 +
            math.cos(DateTime.now().millisecondsSinceEpoch *
                    0.01 /
                    pulsePeriod) *
                (1.0 - 0.25) /
                2;
      ...
      edgeDetectionMaterial.uniforms['maskTexture']['value'] =
          renderTargetMaskDownSampleBuffer.texture;
      edgeDetectionMaterial.uniforms['texSize']['value'].setValues(
          renderTargetMaskDownSampleBuffer.width.toDouble(),
          renderTargetMaskDownSampleBuffer.height.toDouble());
      edgeDetectionMaterial.uniforms['visibleEdgeColor']['value'] =
          tempPulseColor1;
      edgeDetectionMaterial.uniforms['hiddenEdgeColor']['value'] =
          tempPulseColor2;
      ...
      separableBlurMaterial1.uniforms['colorTexture']['value'] =
          renderTargetEdgeBuffer1.texture;
      separableBlurMaterial1.uniforms['direction']['value'] =
      ...
      fsQuad.render(renderer);
      separableBlurMaterial1.uniforms['colorTexture']['value'] =
          renderTargetBlurBuffer1.texture;
      separableBlurMaterial1.uniforms['direction']['value'] =
      ...
      separableBlurMaterial2.uniforms['colorTexture']['value'] =
          renderTargetEdgeBuffer1.texture;
      separableBlurMaterial2.uniforms['direction']['value'] =
          OutlinePass.BlurDirectionX;
      renderer.setRenderTarget(renderTargetBlurBuffer2);
      renderer.clear();
      fsQuad.render(renderer);
      separableBlurMaterial2.uniforms['colorTexture']['value'] =
          renderTargetBlurBuffer2.texture;
      separableBlurMaterial2.uniforms['direction']['value'] =
          OutlinePass.BlurDirectionY;
      ...
      overlayMaterial.uniforms['maskTexture']['value'] =
          renderTargetMaskBuffer.texture;
      overlayMaterial.uniforms['edgeTexture1']['value'] =
          renderTargetEdgeBuffer1.texture;
      overlayMaterial.uniforms['edgeTexture2']['value'] =
          renderTargetEdgeBuffer2.texture;
      overlayMaterial.uniforms['patternTexture']['value'] =
          null; //patternTexture;
      overlayMaterial.uniforms['edgeStrength']['value'] = edgeStrength;
      overlayMaterial.uniforms['edgeGlow']['value'] = edgeGlow;
      overlayMaterial.uniforms['usePatternTexture']['value'] =
          usePatternTexture;
